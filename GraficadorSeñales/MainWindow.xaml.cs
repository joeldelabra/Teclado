...
namespace GraficadorSeñales
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnGraficar_Click(object sender, RoutedEventArgs e)
        {
            ...
            var reader = new AudioFileReader(txtRutaArchivo.Text); //var acepta cualquier tipo de valor
        ...
        private void btnExaminar_Click(object sender, RoutedEventArgs e)
        {
            ...
            OpenFileDialog fileDialog = new OpenFileDialog(); //Abre el cuadro de dialogo del equipo 

            if ((bool)fileDialog.ShowDialog())
            {
                txtRutaArchivo.Text = fileDialog.FileName; //Pone la ruta de ubicacion del archivo seleccionado del cuadro de dialogo
